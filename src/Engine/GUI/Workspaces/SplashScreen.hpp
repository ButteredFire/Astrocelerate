...
public:
	...
	inline bool saveSimulationConfig(const std::string &configPath, const std::string &data) override {};
	inline bool saveWorkspaceConfig(const std::string &configPath, const std::string &data) override {};
