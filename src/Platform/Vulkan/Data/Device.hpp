...
struct QueueFamilyIndices {
	...
	*/
	...
	/* Gets the list of available queue families (based on whether each family has a valid index).
		@param queueFamilies (optional): A vector of queue families to be filtered for available ones. If queueFamilies is not provided, the function will evaluate all queue families in the QueueFamilyIndices struct for availability.
