...
namespace ResourcePath {
	_AppResources App = {
		.SPLASH				= FilePathUtils::JoinPaths(ROOT_DIR, "assets/App/Splash.png"),
		.ASTRO_LOGO			= FilePathUtils::JoinPaths(ROOT_DIR, "assets/App/AstrocelerateLogo.png"),
		.ORIVIET_LOGO		= FilePathUtils::JoinPaths(ROOT_DIR, "assets/App/OrivietAerospaceLogo.png")
	};
